...
admin.site.site_header = "Example Admin Portal"  
admin.site.index_title = "Welcome to Example Admin Portal"
```
...
# create media folder and upload defaults/example.png
product_img = models.ImageField(null=True, blank=True, default="defaults/example.png", upload_to="product/")
...
img directory :  static/images/example.png
add example.png to this directory
base_site.html
```html
...
{% block branding %}
    <div class="myDiv">
    <img src="{% static  'images/example.png' %}" style="height: 50px; width: 50px;" alt="">
    <h1 id="head">
        Example Admin Site
    </h1>
    </div>
